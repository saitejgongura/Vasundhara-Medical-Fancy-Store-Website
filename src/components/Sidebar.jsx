...
export default function Sidebar() {
  ...
  return (
    <aside className="w-72 bg-slate-950 text-white flex flex-col justify-between min-h-screen shadow-2xl">

      {/* Top Section */}
      <div>
        {/* Logo + Clinic Name */}
        <div className="px-6 py-8 border-b border-slate-800 text-center">
          ...
          <h1 className="text-3xl font-extrabold text-white leading-tight mt-5">
            Vasundhara
          </h1>
